...
local ACCENT = {
	base  = Color3.fromRGB(139, 117, 249),
	dim   = Color3.fromRGB(52, 45, 92),
	light = Color3.fromRGB(181, 162, 255),
}
...
titleLbl.Text = "MM2 Coin Autofarm"
...
print("MM2 Coin Autofarm loaded")
